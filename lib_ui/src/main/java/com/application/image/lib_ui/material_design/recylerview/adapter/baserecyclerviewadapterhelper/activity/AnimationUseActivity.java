...
import com.application.image.lib_ui.material_design.recylerview.adapter.baserecyclerviewadapterhelper.adapter.AnimationAdapter;
import com.application.image.lib_ui.material_design.recylerview.adapter.baserecyclerviewadapterhelper.animator.CustomAnimation1;
import com.application.image.lib_ui.material_design.recylerview.adapter.baserecyclerviewadapterhelper.animator.CustomAnimation2;
...
//        mAnimationAdapter.setNotDoAnimationCount(mFirstPageItemCount);
        ...
        mAnimationAdapter.setOnItemChildClickListener(new OnItemChildClickListener() {
            ...
            public void onItemChildClick(@NonNull BaseQuickAdapter adapter, @NonNull View view, int position) {
                ...
                } else if (id == R.id.tweetName) {
                    content = "name:" + status.getUserName();
                } else if (id ==R.id.tweetText) {
