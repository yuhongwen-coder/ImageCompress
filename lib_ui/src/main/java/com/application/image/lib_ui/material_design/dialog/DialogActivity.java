...
public class DialogActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.showConfirmDialog) {
            showConfirmDialog();
        } else if (id ==R.id.showDateDialog) {
            showDateDialog();
        } else if (id ==R.id.showInsertDialog) {
            showInsertDialog();
        } else if (id ==R.id.showIntervalInsertDialog) {
            showIntervalInsertDialog();
        } else if (id ==R.id.showListDialog) {
            showListDialog();
        } else if (id ==R.id.showPasswordInsertDialog) {
        ...
        } else if (id ==R.id.showTimeDialog) {
            showTimeDialog();
        } else if (id ==R.id.showTips) {
