package com.application.image.lib_ui.material_design.viewpager.adapter.fragmentStatePagerAdapter;
...
public class PhotoViewerActivity extends AppCompatActivity {
    ...
    private static final String EXTRA_TYPE = "photoviewer_extra_type";
    ...
    public static void startPhotoViewerActivity(Context context, ArrayList<String> images, int position, int type) {
        Intent intent = new Intent(context, PhotoViewerActivity.class);
        intent.putStringArrayListExtra(EXTRA_IMAGES, images);
    ...
    private void setupViews(PhotoViewPager viewPager) {
        ...
        FragmentStatePagerAdapter adapter = new FragmentStatePagerAdapter(getSupportFragmentManager()) {
            ...
            public Fragment getItem(int i) {
                ...
                if (intExtra==1){
//                    image= IpManager.getInstance().getBaggageImageUrlById(image);
                }
