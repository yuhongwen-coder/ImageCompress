package com.application.image.lib_ui.material_design.recylerview.multi_adapter.listener;

import com.application.image.lib_ui.material_design.recylerview.multi_adapter.bean.BaseIndexPinyinBean;
import com.application.image.lib_ui.material_design.recylerview.multi_adapter.listener.IIndexBarDataHelper;
...
public class IndexBarDataHelperImpl implements IIndexBarDataHelper {
    ...
    public IIndexBarDataHelper fillInexTag(List<? extends BaseIndexPinyinBean> datas) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (indexPinyinBean.isNeedToPinyin()) {
                //以下代码设置城市拼音首字母
                String tagString = indexPinyinBean.getBaseIndexPinyin().toString();
