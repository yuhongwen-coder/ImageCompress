...
/**
 * Created by maxvision on 2018/4/26.
 */
...
public class LogUtils {
    ...
    private static void printDeviceInfo(final String filePath) {
        ...
        try {
            ...
            PackageInfo pi = ((Context)getApplication())
                    .getPackageManager()
                    .getPackageInfo(((Context)getApplication()).getPackageName(), 0);
            if (pi != null) {
    ...
    /**
     * filePath
     *     /storage/emulated/0/Android/data/com.maxvision.fxlj/cache/log/util-11-10.txt
     * @param input
     * @param filePath
     */
    ...
    public static class Config {
        ...
        private Config() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && getApplication().getExternalCacheDir() != null)
                mDefaultDir = getApplication().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                mDefaultDir = ((Context)getApplication()).getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
